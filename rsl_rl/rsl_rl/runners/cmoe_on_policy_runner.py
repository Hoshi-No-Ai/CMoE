...
from rsl_rl.algorithms import CMoEPPO
from rsl_rl.modules.cmoe_actor_critic import CMoEActorCritic
...
class CMoEOnPolicyRunner:
    ...
    def __init__(self,
        ...
        actor_critic_class = eval('CMoEActorCritic') # CMoEActorCritic

        actor_critic: CMoEActorCritic = actor_critic_class( self.env.num_obs,
                                                        num_critic_obs,
        ...
        alg_class = eval("CMoEPPO") # CMoEPPO
        self.alg: CMoEPPO = alg_class(actor_critic, device=self.device, **self.alg_cfg)
        ...
        for it in range(self.current_learning_iteration, tot_iter):
            ...
            with torch.inference_mode():
                for i in range(self.num_steps_per_env):
                    ...
                    obs, privileged_obs, rewards, dones, infos, termination_ids, termination_privileged_obs ,_= self.env.step(actions)
                    critic_obs = privileged_obs if privileged_obs is not None else obs
